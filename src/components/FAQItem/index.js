      ...
      <div>
        ...
        { props.relatedLink1 &&
          <div className={FAQItemStyles.relatedLinks}>
            <h3>Related Links:</h3>
            <ul>
              <li className={FAQItemStyles.answerListItems}>
                <a href={ props.relatedLink1 } target="_blank" rel="noopener noreferrer">{ props.relatedLink1 }</a>
              </li>
              { props.relatedLink2 &&
                <li className={FAQItemStyles.answerListItems}>
                  <a href={ props.relatedLink2 } target="_blank" rel="noopener noreferrer">{ props.relatedLink2 }</a>
                </li> 
              }
              { props.relatedLink3 &&
                <li className={FAQItemStyles.answerListItems}>
                  <a href={ props.relatedLink3 } target="_blank" rel="noopener noreferrer">{ props.relatedLink3 }</a>
                </li> 
              }
            </ul>
          </div>
